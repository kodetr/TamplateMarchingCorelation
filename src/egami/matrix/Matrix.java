...
public class Matrix {
    ...
    /**
     * <code>WHITE_PIXEL = 255</code>, highest value of a <code>pixel</code>
     * <br/>
    ...
    /**
     * first dimension represents row or height from top to bottom ranging from
     * 0 to height-1, second dimension represents column or width from left to
     * right ranging from 0 to width-1, third dimension represents intensity
     * value.
     */
    public int[][][] pixels;
...
////----getter setters----////
    ...
    /**
     * @param rowNo 0 =< rowNo < number of rows @param colN
     * o 0 =< colNo < number of columns
     */
...
////----methods----////
	 ...
	 * @pa
     * ram rowEnd rowStart < rowEnd <= numberOfRows-1 @param colSt
     * art 0 =< colStart < colEnd
	 * @pa
     * ram colEnd colStart < colEnd <= numberOfCols-1 @return a ne
     * w Matrix
     */
